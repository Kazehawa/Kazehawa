  ...
  <div class="news-label">News</div>
      ...
      <div class="news-container">
                <div class="full-news-container">
                  <h2 class="newscard-title">{{ $news->title }}</h2>
                  <img src="{{ asset('uploads/thumbnails/'.$news->image) }}" alt="" class="newscard-image">   
                  <p class="full-news-content">{{ $news->description }}</p>

                  <a href="{{ url()->previous() }}" class="full-news-back-button">Back to News</a>
                </div>
       </div>
 </div>
...
<footer class="footer">
     ...
     <div class="rights">
  <h5>@Dipendra Budha Magar Copyrights Reserved.</h5>
