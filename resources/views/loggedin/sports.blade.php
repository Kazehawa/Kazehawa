...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="cssloggedinfootball.css">
    <link rel="stylesheet" href="cssloggedinfootballtable.css">
        ...
        <div class="bar">
          <div class="news-label">Sports</div>
            ...
            <div class="sportscard-container">
                ...
                <a href="loggedinfootball"><div class="sportscard">
                <img src="{{ asset('uploads/thumbnails/'.$sport->image) }}" alt="" >          
                    <div class="sportscard-footer">
                        <span class="sportscardname">{{ $sport->name }}</span>
                    </div>
                </div>
                </a>
                @endforeach
